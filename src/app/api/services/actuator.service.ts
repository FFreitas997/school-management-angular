...
import { customEndpoint } from '../fn/actuator/custom-endpoint';
import { CustomEndpoint$Params } from '../fn/actuator/custom-endpoint';
import { customEndpoint2 } from '../fn/actuator/custom-endpoint-2';
import { CustomEndpoint2$Params } from '../fn/actuator/custom-endpoint-2';
...
import { logfile } from '../fn/actuator/logfile';
import { Logfile$Params } from '../fn/actuator/logfile';
...
export class ActuatorService extends BaseService {
  ...
  static readonly LoggersNamePath = '/api/v1/admin/management-server/loggers/{name}';
  ...
  static readonly LoggersName2Path = '/api/v1/admin/management-server/loggers/{name}';
  ...
  /** Path part for operation `customEndpoint()` */
  static readonly CustomEndpointPath = '/api/v1/admin/management-server/custom-endpoint';

  /**
   * Actuator web endpoint 'custom-endpoint'.
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `customEndpoint()` instead.
   *
   * This method doesn't expect any request body.
   */
  customEndpoint$Response(params?: CustomEndpoint$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
    return customEndpoint(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `customEndpoint$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  customEndpoint(params?: CustomEndpoint$Params, context?: HttpContext): Observable<{
}> {
    return this.customEndpoint$Response(params, context).pipe(
      map((r: StrictHttpResponse<{
}>): {
} => r.body)
    );
  ...
  /** Path part for operation `customEndpoint2()` */
  static readonly CustomEndpoint2Path = '/api/v1/admin/management-server/custom-endpoint';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `customEndpoint2()` instead.
   *
   * This method doesn't expect any request body.
   */
  customEndpoint2$Response(params?: CustomEndpoint2$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
    return customEndpoint2(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `customEndpoint2$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  customEndpoint2(params?: CustomEndpoint2$Params, context?: HttpContext): Observable<{
}> {
    return this.customEndpoint2$Response(params, context).pipe(
      map((r: StrictHttpResponse<{
}>): {
} => r.body)
    );
  ...
  static readonly LinksPath = '/api/v1/admin/management-server';
...
[key: string]: Link;
  ...
  static readonly ThreaddumpPath = '/api/v1/admin/management-server/threaddump';
  ...
  static readonly ScheduledtasksPath = '/api/v1/admin/management-server/scheduledtasks';
  ...
  static readonly MetricsPath = '/api/v1/admin/management-server/metrics';
  ...
  static readonly MetricsRequiredMetricNamePath = '/api/v1/admin/management-server/metrics/{requiredMetricName}';
  ...
  static readonly MappingsPath = '/api/v1/admin/management-server/mappings';
  ...
  static readonly LoggersPath = '/api/v1/admin/management-server/loggers';
  ...
  /** Path part for operation `logfile()` */
  static readonly LogfilePath = '/api/v1/admin/management-server/logfile';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `logfile()` instead.
   *
   * This method doesn't expect any request body.
   */
  logfile$Response(params?: Logfile$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
    return logfile(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `logfile$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  logfile(params?: Logfile$Params, context?: HttpContext): Observable<{
}> {
    return this.logfile$Response(params, context).pipe(
      map((r: StrictHttpResponse<{
}>): {
} => r.body)
    );
  ...
  static readonly InfoPath = '/api/v1/admin/management-server/info';
  ...
  static readonly HeapdumpPath = '/api/v1/admin/management-server/heapdump';
  ...
  static readonly HealthPath = '/api/v1/admin/management-server/health';
  ...
  static readonly HealthPathPath = '/api/v1/admin/management-server/health/**';
  ...
  static readonly EnvPath = '/api/v1/admin/management-server/env';
  ...
  static readonly EnvToMatchPath = '/api/v1/admin/management-server/env/{toMatch}';
  ...
  static readonly ConfigpropsPath = '/api/v1/admin/management-server/configprops';
  ...
  static readonly ConfigpropsPrefixPath = '/api/v1/admin/management-server/configprops/{prefix}';
  ...
  static readonly ConditionsPath = '/api/v1/admin/management-server/conditions';
  ...
  static readonly CachesPath = '/api/v1/admin/management-server/caches';
  ...
  static readonly Caches2Path = '/api/v1/admin/management-server/caches';
  ...
  static readonly CachesCachePath = '/api/v1/admin/management-server/caches/{cache}';
  ...
  static readonly CachesCache2Path = '/api/v1/admin/management-server/caches/{cache}';
  ...
  static readonly BeansPath = '/api/v1/admin/management-server/beans';
